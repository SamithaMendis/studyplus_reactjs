        ...
        <GridContainer className={classes.textCenter} justify="center">
          ...
          <GridItem xs={12} sm={8} md={6}>
            <Button
              color="primary"
              size="lg"
              href="http://www.codemaxsoftwares.com/product/material-kit-react?ref=mkr-download-section"
              target="_blank"
            >
              Free React Download
            </Button>
            <Button
              color="primary"
              size="lg"
              href="http://www.codemaxsoftwares.com/product/material-kit?ref=mkr-download-section"
              target="_blank"
            >
              Free HTML Downoad
            </Button>
        ...
        <GridContainer className={classes.textCenter} justify="center">
          <GridItem xs={12} sm={12} md={8}>
            ...
            <h4>
              We{"'"}ve launched{" "}
              <a
                href="http://www.codemaxsoftwares.com/product/material-kit-pro-react?ref=mkr-download-section"
                target="_blank"
              >
          ...
          <GridItem xs={12} sm={8} md={6}>
            ...
            <Button
              color="rose"
              size="lg"
              href="http://www.codemaxsoftwares.com/product/material-dashboard-pro-react?ref=mkr-download-section"
              target="_blank"
            >
