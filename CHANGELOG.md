...
- https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/67
...
- Solved https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/52
- Solved https://github.com/codemaxsoftwaretimofficial/ct-material-dashboard-pro-react/issues/149
...
- https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/46
- https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/44
- Updated available scripts
- Changed the _.babelrc_ file

### Major style changes

- **src/assets/jss/studyplus-react/components/headerStyle.jsx**
- **src/assets/jss/studyplus-react/components/customDropdownStyle.jsx**
...
- Github own repo
  - [https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/36](https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/36)
- Github othe repos
  - [https://github.com/codemaxsoftwaretimofficial/ct-material-dashboard-pro-react/issues/79](https://github.com/codemaxsoftwaretimofficial/ct-material-dashboard-pro-react/issues/79)

### Major styling changes

- `src/assets/jss/studyplus-react/components/headerStyle.jsx`
- `src/assets/jss/studyplus-react/components/snackbarContentStyle.jsx`
- `src/assets/jss/studyplus-react/views/loginPage.jsx`
- `src/assets/jss/studyplus-react/customCheckboxRadioSwitch.jsx`
- `src/assets/scss/plugins/_plugin-nouislider.scss`
...
- Github
  - [https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/16](https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/16)
  - [https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/25](https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/25)
  - [https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/26](https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/26)
  - [https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/28](https://github.com/codemaxsoftwaretimofficial/studyplus-react/issues/28)

### Major styling changes

- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/studyplus-react/components/buttonStyle.jsx`
  - `src/assets/jss/studyplus-react/components/customInputStyle.jsx`
  - `src/assets/jss/studyplus-react/components/customDropdownStyle.jsx`
  - `src/assets/jss/studyplus-react/components/headerLinksStyle.jsx`
  - `src/assets/jss/studyplus-react/components/headerStyle.jsx`
  - `src/assets/jss/studyplus-react/views/loginPage.jsx`
...
- `src/assets/jss/studyplus-react/components/buttonStyle.jsx`, due to the fact that we've droped `src/components/CustomButtons/IconButton.jsx`
- `src/assets/jss/studyplus-react/components/customInputStyle.jsx`
- `src/assets/jss/studyplus-react/components/customTabsStyle.jsx`
- `src/assets/jss/studyplus-react/components/headerLinksStyle.jsx`
...
- Added design from Material Dashboard byCodeMax
